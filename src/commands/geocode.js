...
module.exports.run = async (client, message, arguments) => {
    ...
    if (!message.member.hasPermission(permissions.geocode)) return message.reply(response.command.chooseMessageResponse((personality.command.geocode.permission), message));
