...
module.exports.run = async (client, message, arguments) => {
    ...
    if (!message.member.hasPermission(permissions.serverinfo)) return message.reply(response.command.chooseMessageResponse(personality.command.git.permission, message));
